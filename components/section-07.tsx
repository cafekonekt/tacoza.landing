            ...
            <div className="relative max-w-xl mx-auto md:max-w-none text-center md:text-left">
              ...
              >
                ...
                <div className="relative flex flex-col h-full rounded-br-[100px] py-5 px-6">
                  ...
                  <div className="mb-5">
                    <div className="text-2xl text-stone-800 font-bold text-center mb-4">$0/m</div>
                    <a className="btn-sm w-full inline-flex items-center text-rose-50 bg-rose-500 hover:bg-rose-600 shadow-sm" href="#0">
                      Get Starter
                    </a>
                  </div>
                  <div className="text-stone-800 font-medium mb-4">Features include</div>
                  <ul className="text-slate-500 text-left space-y-2">
                    <li className="flex items-start">
                      <svg className="w-3 h-3 fill-current text-red-500 mr-3 mt-1.5 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="relative flex flex-col h-full bg-gradient-to-b from-rose-100 to-rose-50 rounded-br-[100px] py-5 px-6">
                  ...
                  <div className="mb-5">
                    <div className="text-2xl text-stone-800 font-bold text-center mb-4">$12/m</div>
                    <a className="btn-sm w-full inline-flex items-center text-slate-100 bg-stone-800 hover:bg-slate-900 shadow-sm" href="#0">
                      Get Smart
                    </a>
                  </div>
                  <div className="text-stone-800 font-medium mb-4">Everything in Starter, plus</div>
                  <ul className="text-slate-500 text-left space-y-2">
                    <li className="flex items-start">
                      <svg className="w-3 h-3 fill-current text-red-500 mr-3 mt-1.5 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
                ...
                <div className="relative flex flex-col h-full rounded-br-[100px] py-5 px-6">
                  ...
                  <div className="mb-5">
                    <div className="text-2xl text-stone-800 font-bold text-center mb-4">$24/m</div>
                    <a className="btn-sm w-full inline-flex items-center text-rose-50 bg-rose-500 hover:bg-rose-600 shadow-sm" href="#0">
                      Get You
                    </a>
                  </div>
                ...
                <div className="relative flex flex-col h-full rounded-br-[100px] py-5 px-6">
                  ...
                  <div className="mb-5">
                    <div className="text-2xl text-stone-800 font-bold text-center mb-4">$49/m</div>
                    <a className="btn-sm w-full inline-flex items-center text-rose-50 bg-rose-500 hover:bg-rose-600 shadow-sm" href="#0">
                      Get Black
                    </a>
                  </div>
                  <div className="text-stone-800 font-medium mb-4">Everything in You, plus</div>
                  <ul className="text-slate-500 text-left space-y-2">
                    <li className="flex items-start">
                      <svg className="w-3 h-3 fill-current text-red-500 mr-3 mt-1.5 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
