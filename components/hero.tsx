        ...
        <div className="pt-36 md:pt-40 md:pb-20">
          ...
          <div className="relative max-w-xl mx-auto md:max-w-none text-center md:text-left">
            ...
            <div className="md:w-[600px]">
              ...
              Streamline Ordering and Operations for your{' '}
              ...
              <p className="text-lg text-rose-200 mb-8" data-aos="fade-up" data-aos-delay="200">
              Empower your business with Tacoza’s all-in-one solution,              <br className="hidden md:block" /> built to optimize your ordering process and management.  
              </p>
              ...
              >
                <div>
                  <Link className="btn-sm w-full inline-flex items-center text-slate-100 bg-stone-800 hover:bg-stone-900 group shadow-sm" href="/apply">
                    Outlet Onbording
