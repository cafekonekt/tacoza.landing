      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 lg:grid-cols-10 gap-8 py-8 border-t border-slate-700">
          ...
          <div className="sm:col-span-12 lg:col-span-2 lg:max-w-xs">
            ...
            <Image src="/images/logo.png" alt="tacoza" width={150} height={50} />
            </Link>
          </div>
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="text-sm font-[450] space-y-2">
              <li>
                <a className="text-slate-400 hover:text-rose-500 transition duration-150 ease-in-out" href="#0">
                  Payments
                </a>
              </li>
              <li>
        ...
        <div className="pb-4 md:pb-8">
          <div className="text-xs text-slate-500">
            ...
            <a className="font-medium underline hover:text-rose-500 transition duration-150 ease-in-out" href="#0">
              here
            </a>{' '}
