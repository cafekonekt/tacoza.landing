    ...
    <footer className="pt-8 mt-8 border-t border-slate-200">
      <div className="flex items-center space-x-6">
        ...
        <div className="flex items-center space-x-2">
          <button className="btn-sm text-sm px-3 py-1.5 inline-flex items-center text-rose-50 bg-rose-500 hover:bg-rose-600 shadow-sm">
            <svg className="shrink-0 fill-rose-300 mr-2" width="12" height="13" xmlns="http://www.w3.org/2000/svg">
